...
//     planet.forEach((planetElement, index) => {
...
//     skillbtns.forEach((button,index) => {
...
//         const angle = performance.now() * data.speed / 10;
